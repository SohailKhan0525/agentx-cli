...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/SohailKhan0525/agentx-cli/releases) ou [opencode.ai/download](https://opencode.ai/download).
