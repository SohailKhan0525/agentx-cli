...
import { tool } from "@agent-qofeno/plugin"
...
This tool searches PRs in the SohailKhan0525/agentx-cli repository and returns LLM-friendly results including:
- PR number and title
- Author
...
Use the query parameter to search for keywords that might appear in PR titles or descriptions.`,
  ...
  async execute(args) {
    const owner = "SohailKhan0525"
    const repo = "agentx-cli"
