...
const tableBucketName = `agentx-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `agentx-${$app.stage}-lake-ingest`,
    destination: "iceberg",
