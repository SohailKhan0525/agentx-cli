...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/SohailKhan0525/agentx-cli/releases) او من [opencode.ai/download](https://opencode.ai/download).
