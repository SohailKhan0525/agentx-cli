...
- PR #13942: https://github.com/SohailKhan0525/agentx-cli/pull/13942

## Do Not Translate (Locale Additions)

- `AgentX` (preserve casing in prose; keep `agentx` only when it is part of commands, package names, paths, or code)
- `AgentX Zen`
- `AgentX CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `agentx` in prose when referring to the product name; use `AgentX`
