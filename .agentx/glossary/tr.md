...
- PR #15835: https://github.com/SohailKhan0525/agentx-cli/pull/15835

## Do Not Translate (Locale Additions)

- `AgentX` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `agentx` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `AgentX` in prose, `agentx` only for exact technical identifiers
...
- Avoid changing `agentx` to `AgentX` inside commands, URLs, package names, or code literals
