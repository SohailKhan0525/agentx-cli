...
Use this folder for locale-specific translation guidance that supplements `.agentx/agent/translator.md`.
...
- PR #12345: https://github.com/SohailKhan0525/agentx-cli/pull/12345

## Do Not Translate (Locale Additions)

- `AgentX` (preserve casing)
