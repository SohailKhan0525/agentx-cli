...
Desktop application and browser-based app issues, including `agentx web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core agentx server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

AgentX Zen, AgentX Go, and billing issues.
