...
OpenCode 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/SohailKhan0525/agentx-cli/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下載。
