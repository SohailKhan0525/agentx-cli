...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/SohailKhan0525/agentx-cli/releases) o desde [opencode.ai/download](https://opencode.ai/download).
