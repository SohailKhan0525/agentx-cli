...
- remove the public in-memory `@agent-qofeno/llm` tool loop after replacing its
...
- decide whether to preserve deprecated `@agent-qofeno/llm` orchestration exports
