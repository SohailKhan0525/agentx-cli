...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/SohailKhan0525/agentx-cli/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for SohailKhan0525/agentx-cli...\n")
...
console.log("Fetching npm all-time downloads for agentx-cli...\n")
const npmDownloads = await fetchNpmDownloads("agentx-cli")
