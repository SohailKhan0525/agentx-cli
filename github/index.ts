...
import { createOpencodeClient } from "@agent-qofeno/sdk"
...
function useShareUrl() {
  return isMock() ? "https://github.com/SohailKhan0525/agentx-cli" : "https://github.com/SohailKhan0525/agentx-cli"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://github.com/SohailKhan0525/agentx-cli", {
      method: "POST",
      headers: {
