...
class Database extends Context.Service<Database, DatabaseShape>()("@agentx/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@agentx/example/UserStore") {
