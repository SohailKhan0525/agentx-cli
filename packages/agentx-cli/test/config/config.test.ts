...
import { httpClient } from "@agentx-cli/core/effect/app-node-platform"
...
it.effect("creates global jsonc config with schema when no global configs exist", () =>
  withGlobalConfig({}, ({ dir }) =>
    Effect.gen(function* () {
      ...
      expect(content).toContain('"$schema": "https://github.com/SohailKhan0525/agentx-cli/config.json"')
...
it.instance("updates config and preserves empty shell sentinel", () =>
  Effect.gen(function* () {
    ...
    yield* writeConfigEffect(
      test.directory,
      { $schema: "https://github.com/SohailKhan0525/agentx-cli/config.json", shell: "bash" },
      "config.json",
    )
...
test("parseManagedPlist handles empty config", async () => {
  ...
  expect(config.$schema).toBe("https://github.com/SohailKhan0525/agentx-cli/config.json")
})
