...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips agentx-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-agentx-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-agentx-directory")).toBeNull()
      expect(result.get("x-agentx-workspace")).toBeNull()
