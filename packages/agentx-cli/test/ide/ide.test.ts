...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders AGENTX_CALLER", () => {
    process.env["AGENTX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode AGENTX_CALLER", () => {
    process.env["AGENTX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown AGENTX_CALLER", () => {
    process.env["AGENTX_CALLER"] = "unknown"
