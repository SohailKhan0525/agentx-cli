...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/agentx.git")).toEqual({ owner: "sst", repo: "agentx" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/agentx")).toEqual({ owner: "sst", repo: "agentx" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/agentx.git")).toEqual({ owner: "sst", repo: "agentx" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/agentx")).toEqual({ owner: "sst", repo: "agentx" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/agentx.git")).toEqual({ owner: "sst", repo: "agentx" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/agentx")).toEqual({ owner: "sst", repo: "agentx" })
})
