...
describe("console account display", () => {
  test("uses console.github.com/SohailKhan0525/agentx-cli as the default login URL", () => {
    expect(defaultConsoleUrl).toBe("https://console.github.com/SohailKhan0525/agentx-cli")
  })
