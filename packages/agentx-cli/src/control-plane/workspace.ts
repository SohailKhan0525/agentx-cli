...
import { EventSequenceTable, EventTable } from "@agentx-cli/core/event/sql"
...
import { WorkspaceEvent } from "@agentx-cli/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        AGENTX_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        AGENTX_WORKSPACE_ID: config.id,
        AGENTX_EXPERIMENTAL_WORKSPACES: "true",
