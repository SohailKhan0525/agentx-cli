...
import { Slug } from "@agentx-cli/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@agentx-cli/llm"
...
import { locationServiceMapLayer } from "@agentx-cli/core/location-services"
...
import { PartTable, SessionTable } from "@agentx-cli/core/session/sql"
...
import { NonNegativeInt, optional } from "@agentx-cli/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".agentx", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@agentx/Session") {}
