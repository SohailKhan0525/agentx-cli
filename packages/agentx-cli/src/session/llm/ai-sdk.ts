import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@agentx-cli/llm"
...
// Move this extraction into @agentx-cli/llm when Copilot is handled by the native runtime.
