...
import { makeApi } from "@agentx-cli/protocol/api"
import { LocationMiddleware } from "@agentx-cli/server/location"
import { SessionLocationMiddleware } from "@agentx-cli/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("agentx-root")
...
export const InstanceHttpApi = HttpApi.make("agentx-instance")
...
export const AgentXHttpApi = HttpApi.make("agentx")
