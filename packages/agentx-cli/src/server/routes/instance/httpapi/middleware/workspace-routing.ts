...
>()("@agentx/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@agentx/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.AGENTX_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.AGENTX_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-agentx-directory"] || process.cwd()
}
