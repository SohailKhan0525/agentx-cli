...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@agentx/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@agentx/ACPDirectory") {}
