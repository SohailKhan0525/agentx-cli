...
import { path } from "@agentx-cli/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@agentx-cli/core/project"
...
import { WorktreeEvent } from "@agentx-cli/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `agentx/${name}`
