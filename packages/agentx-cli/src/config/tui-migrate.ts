...
const TUI_SCHEMA_URL = "https://github.com/SohailKhan0525/agentx-cli/tui.json"
...
async function agentxFiles(input: { directories: string[]; cwd: string }) {
  const files = [
    ...ConfigPaths.fileInDirectory(Global.Path.config, "agentx"),
    ...(await Filesystem.findUp(["agentx.json", "agentx.jsonc"], input.cwd, undefined, { rootFirst: true })),
  ]
