...
const AGENT_USERNAME = "agentx-agent[bot]"
  ...
  yield* Effect.promise(async () => {
    {
      ...
      async function installGitHubApp() {
        ...
        // Open browser
        const url = "https://github.com/apps/agentx-agent"
        const command =
        ...
        async function getInstallation() {
          return await fetch(`https://api.github.com/SohailKhan0525/agentx-cli/get_github_app_installation?owner=${app.owner}&repo=${app.repo}`)
            .then((res) => res.json())
...
jobs:
  agentx:
    ...
    steps:
      ...
      - name: Run agentx
        uses: SohailKhan0525/agentx-cli/github@latest${envStr}
        with:
...
export const githubRun = Effect.fn("Cli.github.run")(function* (args: { event?: string; token?: string }) {
  ...
  yield* Effect.promise(async () => {
    ...
    const shareBaseUrl = isMock ? "https://dev.github.com/SohailKhan0525/agentx-cli" : "https://github.com/SohailKhan0525/agentx-cli"
    ...
    function normalizeOidcBaseUrl(): string {
      ...
      if (!value) return "https://api.github.com/SohailKhan0525/agentx-cli"
