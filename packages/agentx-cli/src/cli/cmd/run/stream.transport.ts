...
import type { Event, GlobalEvent, AgentXClient } from "@agentx-cli/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@agentx/RunStreamTransport") {}
