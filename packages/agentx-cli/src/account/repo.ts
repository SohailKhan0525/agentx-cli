...
import { AccountStateTable, AccountTable } from "@agentx-cli/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/AccountRepo") {}
