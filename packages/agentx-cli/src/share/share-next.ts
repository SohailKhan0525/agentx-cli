...
import type * as SDK from "@agentx-cli/sdk/v2"
...
import { SessionShareTable } from "@agentx-cli/core/share/sql"
...
const disabled = process.env["AGENTX_DISABLE_SHARE"] === "true" || process.env["AGENTX_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/ShareNext") {}
