...
export class Service extends Context.Service<Service, Interface>()("@agentx/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __AGENTX_PHOTON_WASM_PATH?: string }).__AGENTX_PHOTON_WASM_PATH =
