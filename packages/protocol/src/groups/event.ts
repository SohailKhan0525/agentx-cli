...
import type { Definition } from "@agentx-cli/schema/event"
...
export const AgentXEvent = event.schema
export type AgentXEvent = typeof AgentXEvent.Type
export type AgentXEventEncoded = typeof AgentXEvent.Encoded
