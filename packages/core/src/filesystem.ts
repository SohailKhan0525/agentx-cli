...
import { Entry, FileSystem, FindInput, Match } from "@agentx-cli/schema/filesystem"
export { Entry, Match, Submatch } from "@agentx-cli/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/v2/FileSystem") {}
