...
/** Intentional public native API for Effect applications embedding AgentX. */
export class Service extends Context.Service<Service, Interface>()("@agentx/public/AgentX") {}
...
>()("@agentx/public/AgentX/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("AgentX.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("AgentX.sessions.switchModel")(function* (input) {
...
// TODO: Add AgentX.create(...) as the Promise facade over the same native API semantics.
