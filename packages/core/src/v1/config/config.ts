...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for agentx serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://github.com/SohailKhan0525/agentx-cli/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://github.com/SohailKhan0525/agentx-cli/docs/agents" }),
