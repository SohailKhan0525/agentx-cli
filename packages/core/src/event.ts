...
import type { Data, Definition, Payload } from "@agentx-cli/schema/event"
...
import { Durable } from "@agentx-cli/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@agentx-cli/schema/event").ID
export type { Data, Definition, Payload } from "@agentx-cli/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/Event") {}
