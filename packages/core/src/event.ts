...
import type { Data, Definition, Payload } from "@agent-qofeno/schema/event"
...
import { Durable } from "@agent-qofeno/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@agent-qofeno/schema/event").ID
export type { Data, Definition, Payload } from "@agent-qofeno/schema/event"
