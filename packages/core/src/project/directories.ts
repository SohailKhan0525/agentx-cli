...
import type { EffectDrizzleSqlite } from "@agentx-cli/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/ProjectDirectories") {}
