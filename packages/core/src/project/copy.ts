...
import { Event } from "@agentx-cli/schema/project-directories"
import { ProjectCopy } from "@agentx-cli/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/ProjectCopy") {}
