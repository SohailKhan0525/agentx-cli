...
import { type Model } from "@agentx-cli/llm"
import * as AnthropicMessages from "@agentx-cli/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@agentx-cli/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@agentx-cli/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@agentx-cli/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/v2/SessionRunnerModel") {}
