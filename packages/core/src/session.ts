...
import { ListAnchor } from "@agentx-cli/schema/session"
...
import { SessionDurable } from "@agentx-cli/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/v2/Session") {}
