...
export class Service extends Context.Service<Service, Interface>()("@agentx/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.AGENTX_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
