...
import { FileSystemWatcher } from "@agentx-cli/schema/filesystem-watcher"
...
declare const AGENTX_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof AGENTX_LIBC === "undefined" ? undefined : AGENTX_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@agentx/v2/FileWatcher") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    if (yield* Flag.AGENTX_EXPERIMENTAL_FILEWATCHER) {
