...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@agentx-cli/llm"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/v2/ToolRegistry") {}
