import type { PluginContext } from "@agentx-cli/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@agentx-cli/sdk/v2/types"
