import type { PluginContext } from "@agent-qofeno/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@agent-qofeno/sdk/v2/types"
