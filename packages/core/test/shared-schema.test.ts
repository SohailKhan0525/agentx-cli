...
import { Agent } from "@agentx-cli/schema/agent"
import { Location } from "@agentx-cli/schema/location"
import { Model } from "@agentx-cli/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@agentx-cli/schema/prompt"
import { Provider } from "@agentx-cli/schema/provider"
import { Project } from "@agentx-cli/schema/project"
import { ProjectDirectories } from "@agentx-cli/schema/project-directories"
import { PermissionV1 } from "@agentx-cli/schema/permission-v1"
import { Session } from "@agentx-cli/schema/session"
import { SessionInput } from "@agentx-cli/schema/session-input"
import { SessionMessage } from "@agentx-cli/schema/session-message"
import { Workspace } from "@agentx-cli/schema/workspace"
import { Command } from "@agentx-cli/schema/command"
import { Connection } from "@agentx-cli/schema/connection"
import { Credential } from "@agentx-cli/schema/credential"
import { FileSystem } from "@agentx-cli/schema/filesystem"
import { Integration } from "@agentx-cli/schema/integration"
import { LLM } from "@agentx-cli/schema/llm"
import { Permission } from "@agentx-cli/schema/permission"
import { Plugin } from "@agentx-cli/schema/plugin"
import { Pty } from "@agentx-cli/schema/pty"
import { Reference } from "@agentx-cli/schema/reference"
import { SessionTodo } from "@agentx-cli/schema/session-todo"
import { Skill } from "@agentx-cli/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@agentx-cli/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@agentx-cli/core/command"),
    import("@agentx-cli/core/integration/connection"),
    import("@agentx-cli/core/credential"),
    import("@agentx-cli/core/filesystem"),
    import("@agentx-cli/core/integration"),
    import("@agentx-cli/core/location"),
    import("@agentx-cli/llm"),
    import("@agentx-cli/core/permission"),
    import("@agentx-cli/core/v1/permission"),
    import("@agentx-cli/core/project/copy"),
    import("@agentx-cli/core/pty"),
    import("@agentx-cli/core/project/schema"),
    import("@agentx-cli/core/reference"),
    import("@agentx-cli/core/session/input"),
    import("@agentx-cli/core/session/message"),
    import("@agentx-cli/core/session/todo"),
    import("@agentx-cli/core/session/prompt"),
    import("@agentx-cli/core/skill"),
    import("@agentx-cli/core/v2-schema"),
    import("@agentx-cli/core/schema"),
    import("@agentx-cli/core/workspace"),
  ])
