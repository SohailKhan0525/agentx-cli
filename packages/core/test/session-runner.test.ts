...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@agent-qofeno/llm"
import * as OpenAIChat from "@agent-qofeno/llm/protocols/openai-chat"
import { Database } from "@agent-qofeno/core/database/database"
import { makeLocationNode } from "@agent-qofeno/core/effect/app-node"
...
import { PermissionV2 } from "@agent-qofeno/core/permission"
import { EventTable } from "@agent-qofeno/core/event/sql"
import { Project } from "@agent-qofeno/core/project"
import { ProjectTable } from "@agent-qofeno/core/project/sql"
import { QuestionV2 } from "@agent-qofeno/core/question"
import { AbsolutePath } from "@agent-qofeno/core/schema"
import { SessionV2 } from "@agent-qofeno/core/session"
import { Snapshot } from "@agent-qofeno/core/snapshot"
import { ContextSnapshotDecodeError } from "@agent-qofeno/core/session/error"
import { SessionEvent } from "@agent-qofeno/core/session/event"
import { SessionInput } from "@agent-qofeno/core/session/input"
import { SessionMessage } from "@agent-qofeno/core/session/message"
import { Prompt } from "@agent-qofeno/core/session/prompt"
import { SessionProjector } from "@agent-qofeno/core/session/projector"
import { SessionExecution } from "@agent-qofeno/core/session/execution"
import { SessionRunCoordinator } from "@agent-qofeno/core/session/run-coordinator"
import { SessionRunner } from "@agent-qofeno/core/session/runner"
import * as SessionRunnerLLM from "@agent-qofeno/core/session/runner/llm"
import { SessionRunnerModel } from "@agent-qofeno/core/session/runner/model"
import { ToolRegistry } from "@agent-qofeno/core/tool/registry"
import { ApplicationTools } from "@agent-qofeno/core/tool/application-tools"
import { AgentV2 } from "@agent-qofeno/core/agent"
import { Config } from "@agent-qofeno/core/config"
import { ConfigCompaction } from "@agent-qofeno/core/config/compaction"
import { Tool } from "@agent-qofeno/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@agent-qofeno/core/session/sql"
import { SessionStore } from "@agent-qofeno/core/session/store"
import { SystemContext } from "@agent-qofeno/core/system-context"
import { SystemContextRegistry } from "@agent-qofeno/core/system-context/registry"
import { SkillGuidance } from "@agent-qofeno/core/skill/guidance"
import { ReferenceGuidance } from "@agent-qofeno/core/reference/guidance"
