...
import {
  ...
  type StatsHomeData,
  type StatsLabData,
} from "@agentx-cli/stats-core/domain/home"
...
export default function StatsLab() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="AgentX" />
  ...
  return (
    ...
    >
      <div data-slot="lab-model-tooltip-summary">
        ...
        <p>{props.state.model.description ?? "Recent AgentX Go usage, share, context, and output limits."}</p>
      </div>
      <div data-slot="tooltip-divider" />
