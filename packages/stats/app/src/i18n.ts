...
const en = {
  "app.title": "AI Model Usage Rankings | AgentX Data",
  "app.description":
    "Explore AgentX Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "AgentX Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star AgentX on GitHub",
  "header.github": "GitHub",
  "header.tryAgentX": "Try AgentX",
  ...
  "home.topModelsDescription": "Usage of models across AgentX Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique AgentX Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | AgentX Data",
  "lab.description":
    "Compare {{lab}} models used in AgentX Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent AgentX usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in AgentX",
  ...
  "lab.shareOfUsage": "{{share}} of recent AgentX usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | AgentX Data",
  "model.description":
    "View {{model}} AgentX Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. AgentX Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's AgentX Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's AgentX Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No AgentX Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent AgentX Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no AgentX Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily AgentX Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique AgentX Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average AgentX Go session shape.",
  ...
  "model.geoDescription": "AgentX Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No AgentX Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent AgentX Go token volume.",
