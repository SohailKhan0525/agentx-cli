export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | AgentX Data",
  "app.description":
    "AgentX Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde AgentX Data logosu",
  ...
  "header.githubAria": "GitHub'da AgentX'a yıldız ver",
  "header.github": "GitHub",
  "header.tryAgentX": "AgentX'u dene",
  ...
  "footer.homeAria": "AgentX ana sayfası",
  ...
  "home.topModelsDescription": "AgentX Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz AgentX Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | AgentX Data",
  "lab.description":
    "AgentX Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son AgentX kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "AgentX'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son AgentX kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük AgentX token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | AgentX Data",
  "model.description":
    "{{model}} için AgentX Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda AgentX Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki AgentX Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki AgentX Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde AgentX Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son AgentX Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz AgentX Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük AgentX Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz AgentX Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama AgentX Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan AgentX Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen AgentX Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son AgentX Go token hacmine göre yakındaki modeller.",
