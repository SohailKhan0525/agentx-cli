export const dict = {
  "app.title": "Rankingi użycia modeli AI | AgentX Data",
  "app.description":
    "Przeglądaj użycie AgentX Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny AgentX Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę AgentX na GitHub",
  "header.github": "GitHub",
  "header.tryAgentX": "Wypróbuj AgentX",
  ...
  "footer.homeAria": "Strona główna AgentX",
  ...
  "home.topModelsDescription": "Użycie modeli w AgentX Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy AgentX Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | AgentX Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w AgentX Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia AgentX.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w AgentX",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia AgentX",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów AgentX z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | AgentX Data",
  "model.description":
    "Zobacz dane użycia {{model}} w AgentX Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie AgentX Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu AgentX Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu AgentX Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia AgentX Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny AgentX Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia AgentX Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów AgentX Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy AgentX Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji AgentX Go.",
  ...
  "model.geoDescription": "Tokeny modelu AgentX Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne AgentX Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów AgentX Go.",
