...
Practical reference for the current tool-migration state in `packages/agentx`.
...
Tool tests should use the existing Effect helpers in `packages/agentx/test/lib/effect.ts`:
