...
await fs.promises.writeFile(configFile, JSON.stringify(generate(Config.Info), null, 2))

if (tuiFile) {
  console.log(tuiFile)
  await fs.promises.writeFile(tuiFile, JSON.stringify(generate(TuiConfig.Info), null, 2))
}
