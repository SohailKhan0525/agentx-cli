...
import { LocalModelSetup } from "./local-model-setup"
      ...
      map((provider) => {
        ...
        return {
          ...
          description: {
            ...
            local: "(Ollama, LM Studio, Jan, etc.)",
          }[provider.id],
      ...
      description={
        {
          agentx: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://agentx.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "agentx-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://agentx.ai/zen</span> and enable AgentX Go
              </text>
            </box>
          ),
