import type { PermissionV1 } from "@agent-qofeno/core/v1/permission"
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@agent-qofeno/sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to OPENCODE_SERVER_USERNAME or 'agentx')",
      })
      .option("dir", {
        type: "string",
