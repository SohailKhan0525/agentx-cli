...
//
// The saved variant persists across sessions in ~/.local/state/agentx/model.json
...
class Service extends Context.Service<Service, VariantService>()("@agentx/RunVariant") {}
