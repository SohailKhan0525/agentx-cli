...
import { openEditor } from "@agentx-cli/tui/editor"
import { registerAgentXKeymap } from "@agentx-cli/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerAgentXKeymap(keymap, renderer, input.tuiConfig)
