...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@agent-qofeno/sdk/v2"
...
function defaultModelFromConfig(
  ...
  const opencodeProvider = providers[ProviderV2.ID.make("agentx")]
