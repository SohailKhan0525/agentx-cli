...
import { Hash } from "@agent-qofeno/core/util/hash"
...
import { optional } from "@agent-qofeno/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@agent-qofeno/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
