...
const DEFAULT_TIMEOUT = Flag.AGENTX_EXPERIMENTAL_BASH_DEFAULT_TIMEOUT_MS || 2 * 60 * 1000
...
const parser = lazy(async () => {
  ...
  const psPath = resolveWasm("tree-sitter-powershell/tree-sitter-powershell.wasm")
