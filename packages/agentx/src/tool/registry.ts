...
import { ComponentRegistryTool } from "./component_registry"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.agentx || flags.exa || flags.parallel
}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const componentRegistry = yield* ComponentRegistryTool
