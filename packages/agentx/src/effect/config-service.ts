 ...
 *   "@agentx/ServerAuthConfig",
 *   {
 *     password: Config.string("AGENTX_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("AGENTX_SERVER_USERNAME").pipe(Config.withDefault("agentx")),
 *   },
 * ) {}
 *
