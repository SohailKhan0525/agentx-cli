...
import { ProjectDirectoryTable, ProjectTable } from "@agentx-cli/core/project/sql"
import { ProjectDirectories } from "@agentx-cli/core/project/directories"
...
import { which } from "@agentx-cli/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@agentx-cli/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@agentx/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.AGENTX_FAKE_VCS)
