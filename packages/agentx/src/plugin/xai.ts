...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=agentx` lets xAI attribute agentx-originated
...
<html>
  <head>
    <title>AgentX - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>AgentX - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire agentx process. Matches the silent-
