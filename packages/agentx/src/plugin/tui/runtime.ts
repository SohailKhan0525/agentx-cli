...
import {
  ...
  type TuiSlotPlugin,
  type TuiTheme,
} from "@agent-qofeno/plugin/tui"
import path from "path"
import { fileURLToPath } from "url"
import { TuiConfig } from "@/config/tui"
import { AppNodeBuilder } from "@agent-qofeno/core/effect/app-node-builder"
import { errorData, errorMessage } from "@agent-qofeno/tui/util/error"
import { isRecord } from "@agent-qofeno/tui/util/record"
...
import { hasTheme, upsertTheme } from "@agent-qofeno/tui/context/theme"
import { Global } from "@agent-qofeno/core/global"
import { Filesystem } from "@/util/filesystem"
import { Process } from "@/util/process"
import { Flock } from "@agent-qofeno/core/util/flock"
import { Flag } from "@agent-qofeno/core/flag/flag"
import { internalTuiPlugins, type InternalTuiPlugin } from "./internal"
import type { HostPluginApi, HostSlots } from "@agent-qofeno/tui/plugin/slots"
import { ConfigPlugin } from "@/config/plugin"
import { ConfigPluginV1 } from "@agent-qofeno/core/v1/config/plugin"
import { createCommandShim } from "@agent-qofeno/tui/plugin/command-shim"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Effect } from "effect"
import { createPluginRuntime, type PluginRuntime, type TuiPluginHost } from "@agent-qofeno/tui/plugin/runtime"
