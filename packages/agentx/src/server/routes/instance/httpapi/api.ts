...
import { makeApi } from "@agent-qofeno/protocol/api"
import { LocationMiddleware } from "@agent-qofeno/server/location"
import { SessionLocationMiddleware } from "@agent-qofeno/server/middleware/session-location"
...
export const OpenCodeHttpApi = HttpApi.make("agentx")
