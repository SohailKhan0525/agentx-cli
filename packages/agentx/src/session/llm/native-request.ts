import type { JsonSchema, LLMRequest, ProviderMetadata } from "@agent-qofeno/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@agent-qofeno/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @agent-qofeno/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
