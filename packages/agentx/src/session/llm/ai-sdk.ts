import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@agent-qofeno/llm"
...
// Move this extraction into @agent-qofeno/llm when Copilot is handled by the native runtime.
