...
import { llmClient } from "@agent-qofeno/core/effect/app-node-platform"
...
import type { LLMEvent } from "@agent-qofeno/llm"
import { LLMClient } from "@agent-qofeno/llm/route"
import type { LLMClientService } from "@agent-qofeno/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @agent-qofeno/llm. It
