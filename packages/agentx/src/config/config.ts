...
import { serviceUse } from "@agent-qofeno/core/effect/service-use"
...
import { InstallationLocal, InstallationVersion } from "@agent-qofeno/core/installation/version"
import { existsSync } from "fs"
import { Account } from "@/account/account"
import { isRecord } from "@/util/record"
import type { ConsoleState } from "@agent-qofeno/core/v1/config/console-state"
import { FSUtil } from "@agent-qofeno/core/fs-util"
import { InstanceState } from "@/effect/instance-state"
import { Context, Duration, Effect, Exit, Fiber, Layer, Option, Schema } from "effect"
import { FetchHttpClient, HttpClient, HttpClientRequest } from "effect/unstable/http"
import { EffectFlock } from "@agent-qofeno/core/util/effect-flock"
import { containsPath, type InstanceContext } from "../project/instance-context"
import { ConfigV1 } from "@agent-qofeno/core/v1/config/config"
import { RemoteAuthError } from "@agent-qofeno/core/v1/config/error"
import { ConfigPermissionV1 } from "@agent-qofeno/core/v1/config/permission"
import { ConfigPluginV1 } from "@agent-qofeno/core/v1/config/plugin"
    ...
    const loadInstanceState = Effect.fn("Config.loadInstanceState")(
      function* (ctx: InstanceContext) {
        ...
        for (const dir of directories) {
          if (dir.endsWith(".agentx") || dir.endsWith(".opencode") || dir === Flag.AGENTX_CONFIG_DIR) {
            for (const file of ["agentx.json", "agentx.jsonc", "opencode.json", "opencode.jsonc"]) {
