...
describe("console account display", () => {
  test("uses github.com/SohailKhan0525/agentx-cli/console as the default login URL", () => {
    expect(defaultConsoleUrl).toBe("https://github.com/SohailKhan0525/agentx-cli")
  })
