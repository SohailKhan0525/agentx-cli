...
const noAuthLayer = ServerAuth.Config.layer({ password: Option.none(), username: "agentx" })
const secretLayer = ServerAuth.Config.layer({ password: Option.some("secret"), username: "agentx" })
