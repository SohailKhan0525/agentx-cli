...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips agentx-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-agentx-directory"]).toBeUndefined()
      expect(forwarded["x-agentx-workspace"]).toBeUndefined()
