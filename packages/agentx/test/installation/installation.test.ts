...
import { makeGlobalNode } from "@agent-qofeno/core/effect/app-node"
...
import { InstallationChannel } from "@agent-qofeno/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("SohailKhan0525/tap/opencode")) return ""
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("SohailKhan0525/tap/opencode") && args.includes("--formula")) return "opencode"
