...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[OpenCode](https://github.com/SohailKhan0525/agentx-cli)")).toBe(
    '<p><a href="https://github.com/SohailKhan0525/agentx-cli" class="external-link" target="_blank" rel="noopener noreferrer">OpenCode</a></p>\n',
  )
})
