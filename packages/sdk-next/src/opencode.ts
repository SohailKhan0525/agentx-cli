import { OpenCode } from "@agent-qofeno/client/effect"
...
import { createEmbeddedRoutes } from "@agent-qofeno/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@agent-qofeno/sdk-next/OpenCode") {}
