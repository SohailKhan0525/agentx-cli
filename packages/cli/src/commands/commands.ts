...
declare const AGENTX_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof AGENTX_CLI_NAME === "string" ? AGENTX_CLI_NAME : "agentx", {
  description: "AgentX 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
