...
export const TypeId: TypeId = "~@agent-qofeno/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@agent-qofeno/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@agent-qofeno/effect-sqlite-node/NodeSqliteClient")
