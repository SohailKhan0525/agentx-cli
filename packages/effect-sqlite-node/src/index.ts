...
export const TypeId: TypeId = "~@agentx-cli/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@agentx-cli/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@agentx-cli/effect-sqlite-node/NodeSqliteClient")
