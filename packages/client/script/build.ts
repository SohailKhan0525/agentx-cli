...
import { compile, emitEffectImported, emitPromise, write } from "@agentx-cli/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "AgentXEventEncoded",
              import: 'import type { AgentXEventEncoded } from "@agentx-cli/protocol/groups/event"',
            },
          },
        }),
