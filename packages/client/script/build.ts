...
import { compile, emitEffectImported, emitPromise, write } from "@agent-qofeno/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@agent-qofeno/protocol/groups/event"',
            },
          },
        }),
