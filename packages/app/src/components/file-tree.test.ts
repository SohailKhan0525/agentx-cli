...
beforeAll(async () => {
  ...
  mock.module("@agent-qofeno/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@agent-qofeno/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@agent-qofeno/ui/icon", () => ({ Icon: () => null }))
  mock.module("@agent-qofeno/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
