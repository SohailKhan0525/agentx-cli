...
beforeAll(async () => {
  ...
  mock.module("@agentx-cli/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@agentx-cli/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@agentx-cli/ui/icon", () => ({ Icon: () => null }))
  mock.module("@agentx-cli/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
