...
import { Switch } from "@agent-qofeno/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://github.com/SohailKhan0525/agentx-cli/docs/themes/">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_AGENTX_CHANNEL !== "prod"}>
          <SettingsRowV2
