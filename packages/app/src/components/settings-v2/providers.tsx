...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "agentx", key: "dialog.provider.agentx.note" },
  { match: (id: string) => id === "opencode-go", key: "dialog.provider.agentxGo.tagline" },
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "agentx" || item.id === "opencode-go"}>
