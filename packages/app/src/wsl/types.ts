...
export type WslJob =
  ...
  | { kind: "install-agentx"; distro: string; startedAt: number }
...
export type WslServersState = {
  ...
  agentxChecks: Record<string, WslAgentXCheck>
...
export type WslServersPlatform = {
  ...
  installAgentX(name: string): Promise<void>
