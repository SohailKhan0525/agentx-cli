...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "AgentX Documentation", href: "https://github.com/SohailKhan0525/agentx-cli/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/agentx" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/SohailKhan0525/agentx-cli/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/SohailKhan0525/agentx-cli/issues/new?template=bug_report.yml",
      },
    ],
  },
]
