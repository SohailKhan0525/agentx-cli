import type { FilePart, Project, UserMessage, VcsFileDiff } from "@agent-qofeno/sdk/v2"
import { getFilename } from "@agent-qofeno/core/util/path"
...
import type { SessionReviewLineComment } from "@agent-qofeno/session-ui/session-review"
import { ResizeHandle } from "@agent-qofeno/ui/resize-handle"
import { Select } from "@agent-qofeno/ui/select"
import { SelectV2 } from "@agent-qofeno/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@agent-qofeno/ui/scroll-view"
import { Tabs } from "@agent-qofeno/ui/tabs"
import { ButtonV2 } from "@agent-qofeno/ui/v2/button-v2"
import { createAutoScroll } from "@agent-qofeno/ui/hooks"
import { previewSelectedLines } from "@agent-qofeno/session-ui/pierre/selection-bridge"
import { Button } from "@agent-qofeno/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@agent-qofeno/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@agent-qofeno/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@agent-qofeno/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@agent-qofeno/session-ui/v2/session-review-v2"
