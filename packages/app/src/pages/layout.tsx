...
import { Session } from "@agentx-cli/sdk/v2/client"
...
import { toaster } from "@agentx-cli/ui/toast"
...
import { useTheme, type ColorScheme } from "@agentx-cli/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/SohailKhan0525/agentx-cli/desktop-feedback")}
      renderPanel={() =>
