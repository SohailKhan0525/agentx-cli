...
import { base64Encode } from "@agent-qofeno/core/util/encode"
...
import { Session } from "@agent-qofeno/sdk/v2/client"
...
import { retry } from "@agent-qofeno/core/util/retry"
...
import { useTheme, type ColorScheme } from "@agent-qofeno/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://github.com/SohailKhan0525/agentx-cli/desktop-feedback")}
      renderPanel={() =>
