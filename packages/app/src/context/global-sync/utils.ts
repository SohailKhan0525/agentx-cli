import type {
  ...
  PermissionV2Request,
  ProviderListOutput,
} from "@agent-qofeno/client/promise"
import type { Agent, PermissionRequest, Project, Provider, ProviderListResponse } from "@agent-qofeno/sdk/v2/client"
import type { Project as CurrentProject } from "@agent-qofeno/client/promise"
