...
import type { Config, OpencodeClient, Project } from "@agent-qofeno/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@agent-qofeno/client/promise"
import type { NormalizedProviderListResponse } from "@agent-qofeno/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
