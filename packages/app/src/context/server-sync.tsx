...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: AgentXClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: AgentXClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: AgentXClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => AgentXClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, AgentXClient>()
