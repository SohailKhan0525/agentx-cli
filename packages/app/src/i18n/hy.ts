export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.agentxCannotRun": "opencode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode տեղադրված չէ {{distro}}",
  ...
  "dialog.provider.agentx.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.agentx.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.agentxGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "provider.connect.agentxZen.visit.prefix": "Այցելություն ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.agentxReady": "OpenCode պատրաստ է։",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode տեղադրված չէ",
