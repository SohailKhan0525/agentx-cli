export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode er ikki sett upp í hesi distro",
  "desktop.wsl.error.agentxCannotRun": "opencode er sett upp men kundi ikki koyra",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode er ikki sett upp í {{distro}}",
  ...
  "dialog.provider.agentx.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.agentx.tagline": "Álítandi optimerað modell",
  "dialog.provider.agentxGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "provider.connect.agentxZen.visit.prefix": "Vitja ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " fyri at savna tín API lykil.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode er klárt í {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode er klárt.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode ikki innstillað",
