export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode pole sellesse distrosse installitud",
  "desktop.wsl.error.agentxCannotRun": "opencode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode pole installitud asukohta {{distro}}",
  ...
  "dialog.provider.agentx.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.agentx.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.agentxGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "provider.connect.agentxZen.visit.prefix": "Külastage ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " API võtme kättesaamiseks.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode on valmis {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode on valmis.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode pole installitud",
