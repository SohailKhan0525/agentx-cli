export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "ไม่ได้ติดตั้ง opencode ในดิสโทรนี้",
  "desktop.wsl.error.agentxCannotRun": "ติดตั้ง opencode แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.agentxNotInstalled": "ไม่ได้ติดตั้ง OpenCode ใน {{distro}}",
  ...
  "provider.connect.agentxZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.agentxReady": "OpenCode พร้อมใช้งานแล้ว",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "ยังไม่ได้ติดตั้ง OpenCode",
