export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode ကို ဤ distro တွင် ထည့်သွင်းမထားပါ။",
  "desktop.wsl.error.agentxCannotRun": "opencode ကို ထည့်သွင်းထားသော်လည်း မလည်ပတ်နိုင်ပါ။",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode ကို {{distro}} တွင် ထည့်သွင်းမထားပါ။",
  ...
  "dialog.provider.agentx.note": "Claude၊ GPT၊ Gemini နှင့် အခြားအရာများ အပါအဝင် ရွေးချယ်ထားသော မော်ဒယ်များ",
  "dialog.provider.agentx.tagline": "ယုံကြည်စိတ်ချရသော အကောင်းဆုံးပြင်ဆင်ထားသော မော်ဒယ်များ",
  "dialog.provider.agentxGo.tagline": "လူတိုင်းအတွက် ကုန်ကျစရိတ်သက်သာသော စာရင်းသွင်းမှု",
  ...
  "provider.connect.agentxZen.visit.prefix": "လည်ပတ်ပါ။ \nသင်၏ API သော့ကိုစုဆောင်းရန်",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " သို့သွား၍ သင်၏ API key ကို ရယူပါ။",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode သည် {{distro}} တွင် အဆင်သင့်ဖြစ်နေပါပြီ။",
  "wsl.onboarding.agentxReady": "OpenCode အဆင်သင့်ဖြစ်ပါပြီ။",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode ကို ထည့်သွင်းမထားပါ။",
