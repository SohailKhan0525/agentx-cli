export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.agentxCannotRun": "opencode مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode غير مثبت في {{distro}}",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode جاهز في {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode جاهز.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode غير مثبت",
