export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.agentxMissing": "এই ডিস্ট্রোতে opencode ইনস্টল করা নেই",
  "desktop.wsl.error.agentxCannotRun": "opencode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode {{distro}} এ ইনস্টল করা নেই",
  ...
  "dialog.provider.agentx.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.agentx.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.agentxGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "provider.connect.agentxZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.agentxReady": "OpenCode প্রস্তুত।",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode ইনস্টল করা নেই",
