export const dict = {
  ...
  "dialog.provider.agentx.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.agentx.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.agentxGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez AgentX",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w AgentX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w AgentX.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w agentx.json",
  ...
  "dialog.server.description": "Przełącz serwer AgentX, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja AgentX ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu AgentX",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (agentx.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "AgentX zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla AgentX",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd AgentX na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy AgentX ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw AgentX.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania AgentX",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji AgentX.",
