export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "Program opencode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.agentxCannotRun": "Program opencode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode nie jest zainstalowany w dystrybucji {{distro}}",
  ...
  "dialog.provider.agentx.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.agentx.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.agentxGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode jest gotowy.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode nie jest zainstalowany",
