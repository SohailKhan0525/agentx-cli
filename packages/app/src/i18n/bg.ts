export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.agentxCannotRun": "opencode е инсталиран, но не може да стартира",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode не е инсталиран в {{distro}}",
  ...
  "dialog.provider.agentx.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.agentx.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.agentxGo.tagline": "Абонамент на ниска цена за всеки",
  ...
  "provider.connect.agentxZen.visit.suffix": "за да вземете своя ключ API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode е готов в {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode е готов.",
