export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.agentxCannotRun": "opencode đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode chưa được cài đặt trong {{distro}}",
  ...
  "dialog.provider.agentx.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.agentx.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.agentxGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "provider.connect.agentxZen.visit.prefix": "Truy cập ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " để lấy khóa API của bạn.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode đã sẵn sàng.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode chưa được cài đặt",
