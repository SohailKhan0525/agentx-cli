export const dict = {
  ...
  "dialog.provider.agentx.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.agentx.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.agentxGo.tagline": "Abbonamento economico per tutti",
  ...
  "provider.connect.agentxZen.visit.suffix": " per ottenere la tua chiave API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode è pronto in {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode è pronto.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode non installato",
  ...
  "desktop.wsl.error.agentxMissing": "opencode non è installato in questa distribuzione",
  "desktop.wsl.error.agentxCannotRun": "opencode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode non è installato in {{distro}}",
