export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.agentxCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode {{distro}} da o'rnatilmagan",
  ...
  "dialog.provider.agentx.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.agentx.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.agentxGo.tagline": "Hamma uchun arzon obuna",
  ...
  "provider.connect.agentxZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " API kalitingizni olish uchun.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}} da tayyor.",
  "wsl.onboarding.agentxReady": "OpenCode tayyor.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode o'rnatilmagan",
