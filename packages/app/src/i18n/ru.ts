export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode не установлен в этом дистрибутиве",
  "desktop.wsl.error.agentxCannotRun": "opencode установлен, но его не удалось запустить",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode не установлен в {{distro}}",
  ...
  "dialog.provider.agentx.tagline": "Надёжные оптимизированные модели",
  ...
  "provider.connect.agentxZen.visit.suffix": ", чтобы получить ключ API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode в {{distro}} готов к работе.",
  "wsl.onboarding.agentxReady": "OpenCode готов к работе.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode не установлен",
