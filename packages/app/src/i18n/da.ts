export const dict = {
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode er ikke installeret",
  ...
  "desktop.wsl.error.agentxMissing": "opencode er ikke installeret i denne distribution",
  "desktop.wsl.error.agentxCannotRun": "opencode er installeret, men kunne ikke køre",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode er ikke installeret i {{distro}}",
