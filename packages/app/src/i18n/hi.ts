export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "इस डिस्ट्रो में opencode इंस्टॉल नहीं है",
  "desktop.wsl.error.agentxCannotRun": "opencode इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}} में OpenCode इंस्टॉल नहीं है",
  ...
  "dialog.provider.agentx.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.agentx.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.agentxGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "provider.connect.agentxZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.agentxZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}} में तैयार है।",
  "wsl.onboarding.agentxReady": "OpenCode तैयार है।",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode स्थापित नहीं है",
