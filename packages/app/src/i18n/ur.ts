export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "اس ڈسٹری بیوشن میں opencode انسٹال نہیں ہے",
  "desktop.wsl.error.agentxCannotRun": "opencode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}} میں OpenCode انسٹال نہیں ہے",
  ...
  "dialog.provider.agentx.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.agentx.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.agentxGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "provider.connect.agentxZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.agentxReady": "OpenCode تیار ہے۔",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode انسٹال نہیں ہے۔",
