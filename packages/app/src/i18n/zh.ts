...
export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "此发行版中未安装 opencode",
  "desktop.wsl.error.agentxCannotRun": "已安装 opencode，但无法运行",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}} 中未安装 OpenCode",
  ...
  "dialog.provider.agentx.note": "精选模型，包括 Claude、GPT、Gemini 等",
  ...
  "provider.connect.agentxZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "wsl.onboarding.agentxReadyIn": "{{distro}} 中的 OpenCode 已就绪。",
  "wsl.onboarding.agentxReady": "OpenCode 已就绪。",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "未安装 OpenCode",
