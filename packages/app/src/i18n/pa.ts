export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "اس ڈسٹرو وچ opencode انسٹال نئیں اے",
  "desktop.wsl.error.agentxCannotRun": "opencode انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}} وچ OpenCode انسٹال نئیں اے",
  ...
  "dialog.provider.agentx.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.agentx.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.agentxGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "provider.connect.agentxZen.visit.prefix": "ویکھو ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.agentxReady": "OpenCode تیار اے۔",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode انسٹال نئیں کیتا گیا",
