...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "AgentX tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve AgentX'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.agentxZen.line1":
    "AgentX Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve AgentX'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak AgentX'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler agentx.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi AgentX sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "AgentX'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AgentX ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (agentx.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: AgentX henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "AgentX ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "AgentX Masaüstü",
  ...
  "settings.desktop.wsl.description": "AgentX sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "AgentX'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "AgentX'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "AgentX'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "AgentX'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "AgentX başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "AgentX'un en son sürümünü kullanıyorsunuz.",
