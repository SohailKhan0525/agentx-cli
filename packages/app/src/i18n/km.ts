export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode មិនត្រូវបានដំឡើងនៅក្នុង distro នេះទេ។",
  "desktop.wsl.error.agentxCannotRun": "opencode ត្រូវបានដំឡើង ប៉ុន្តែមិនអាចដំណើរការបានទេ។",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode មិនត្រូវបានដំឡើងនៅក្នុង {{distro}} ទេ។",
  ...
  "dialog.provider.agentx.note": "ម៉ូដែលដែលបានជ្រើសរើសរួមមាន Claude, GPT, Gemini និងច្រើនទៀត",
  "dialog.provider.agentx.tagline": "ម៉ូដែលដែលបានកែលម្អដែលអាចទុកចិត្តបាន។",
  "dialog.provider.agentxGo.tagline": "ការជាវតម្លៃទាបសម្រាប់អ្នករាល់គ្នា",
  ...
  "provider.connect.agentxZen.visit.prefix": "ទស្សនា",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "ដើម្បីប្រមូលសោ API របស់អ្នក។",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.agentxReady": "OpenCode គឺរួចរាល់។",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode មិនត្រូវបានដំឡើងទេ។",
