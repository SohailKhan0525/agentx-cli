export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.agentxCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode δεν είναι εγκατεστημένο στο {{distro}}",
  ...
  "dialog.provider.agentx.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.agentx.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.agentxGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "provider.connect.agentxZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode είναι έτοιμο.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode δεν έχει εγκατασταθεί",
