export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.agentxCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode በ{{distro}}] ውስጥ አልተጫነም",
  ...
  "dialog.provider.agentx.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.agentx.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.agentxGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "provider.connect.agentxZen.line1": "OpenCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.agentxZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.agentxZen.visit.prefix": "ጎብኝ ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.agentxReady": "OpenCode ዝግጁ ነው።",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCodeአልተጫነም",
