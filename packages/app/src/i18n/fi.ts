export const dict = {
  ...
  "dialog.provider.agentx.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.agentx.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.agentxGo.tagline": "Edullinen tilaus kaikille",
  ...
  "provider.connect.agentxZen.visit.prefix": "Avaa ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " ja hae API-avaimesi.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode on valmis jakelussa {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCodea ei ole asennettu",
  ...
  "desktop.wsl.error.agentxMissing": "opencodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.agentxCannotRun": "opencode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.agentxNotInstalled": "OpenCodea ei ole asennettu jakeluun {{distro}}",
