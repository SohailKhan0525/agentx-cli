export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode är inte installerat i den här distributionen",
  "desktop.wsl.error.agentxCannotRun": "opencode är installerat men kunde inte köras",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode är inte installerat i {{distro}}",
  ...
  "dialog.provider.agentx.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.agentx.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.agentxGo.tagline": "Lågprisprenumeration för alla",
  ...
  "provider.connect.agentxZen.visit.prefix": "Besök ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " för att hämta din API-nyckel.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode är redo i {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode är redo.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode är inte installerat",
