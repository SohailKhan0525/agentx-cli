export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.agentxCannotRun": "opencode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode no està instal·lat a {{distro}}",
  ...
  "dialog.provider.agentx.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.agentx.tagline": "Models optimitzats fiables",
  "dialog.provider.agentxGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "provider.connect.agentxZen.visit.suffix": " per recollir la teva clau API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode està llest a {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode està llest.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode no instal·lat",
