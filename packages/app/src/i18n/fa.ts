export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode در این توزیع نصب نشده است",
  "desktop.wsl.error.agentxCannotRun": "opencode نصب شده است اما اجرا نمی شود",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode در {{distro}} نصب نشده است",
  ...
  "dialog.provider.agentx.note": "مدل های انتخاب شده از جمله Claude، GPT، Gemini و موارد دیگر",
  "dialog.provider.agentx.tagline": "مدل های بهینه شده قابل اعتماد",
  "dialog.provider.agentxGo.tagline": "اشتراک کم هزینه برای همه",
  ...
  "provider.connect.agentxZen.visit.prefix": "بازدید کنید ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " برای جمع آوری کلید API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode در {{distro}} آماده است.",
  "wsl.onboarding.agentxReady": "OpenCode آماده است.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode نصب نشده است",
