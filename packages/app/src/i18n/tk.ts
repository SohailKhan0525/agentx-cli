export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.agentxCannotRun": "opencode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode {{distro}} gurulmady",
  ...
  "dialog.provider.agentx.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.agentx.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.agentxGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "provider.connect.agentxZen.visit.prefix": "Sapar ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " API açaryňyzy ýygnamak.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}}-de taýýar.",
  "wsl.onboarding.agentxReady": "OpenCode taýýar.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode gurulmady",
