export const dict = {
  ...
  "wsl.onboarding.agentxReadyIn": "{{distro}}에서 OpenCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.agentxReady": "OpenCode가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode가 설치되지 않음",
  ...
  "desktop.wsl.error.agentxMissing": "이 배포판에 opencode가 설치되어 있지 않습니다",
  "desktop.wsl.error.agentxCannotRun": "opencode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}}에 OpenCode가 설치되어 있지 않습니다",
