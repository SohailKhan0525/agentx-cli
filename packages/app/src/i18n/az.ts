export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "Bu distribütivdə opencode quraşdırılmayıb",
  "desktop.wsl.error.agentxCannotRun": "opencode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode {{distro}} distribütivində quraşdırılmayıb",
  ...
  "dialog.provider.agentx.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.agentx.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.agentxGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "provider.connect.agentxZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}}-də hazırdır.",
  "wsl.onboarding.agentxReady": "OpenCode hazırdır.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode quraşdırılmayıb",
