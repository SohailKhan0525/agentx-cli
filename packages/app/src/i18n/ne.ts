export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.agentxMissing": "Opencode यस distro मा स्थापित छैन",
  "desktop.wsl.error.agentxCannotRun": "opencode स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode {{distro}} मा स्थापित छैन",
  ...
  "dialog.provider.agentx.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.agentx.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.agentxGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "provider.connect.agentxZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode {{distro}} मा तयार छ।",
  "wsl.onboarding.agentxReady": "OpenCode तयार छ।",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode स्थापित छैन",
