export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.agentxCannotRun": "opencode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode is niet geïnstalleerd in {{distro}}",
  ...
  "dialog.provider.agentx.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.agentx.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.agentxGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "provider.connect.agentxZen.visit.prefix": "Ga naar ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " om je API-sleutel op te halen.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode is gereed in {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode is klaar.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode niet geïnstalleerd",
