export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode nav instalēts šajā distribūcijā",
  "desktop.wsl.error.agentxCannotRun": "opencode ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode nav instalēts {{distro}}",
  ...
  "dialog.provider.agentx.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.agentx.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.agentxGo.tagline": "Zemas cenas abonements visiem",
  ...
  "provider.connect.agentxZen.visit.prefix": "Apmeklējiet",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode ir gatavs.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode nav instalēts",
