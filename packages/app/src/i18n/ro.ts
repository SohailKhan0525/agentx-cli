export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode nu este instalat în această distribuție",
  "desktop.wsl.error.agentxCannotRun": "opencode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode nu este instalat în {{distro}}",
  ...
  "dialog.provider.agentx.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.agentx.tagline": "Modele optimizate, fiabile",
  "dialog.provider.agentxGo.tagline": "Abonament accesibil pentru toți",
  ...
  "provider.connect.agentxZen.visit.prefix": "Vizitează",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "pentru a obține cheia ta API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode este gata în {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode este gata.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode nu este instalat",
