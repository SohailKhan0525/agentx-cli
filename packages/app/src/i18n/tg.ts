export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode дар ин паҳнкунӣ насб нашудааст",
  "desktop.wsl.error.agentxCannotRun": "opencode насб шудааст, аммо иҷро карда натавонист",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode дар {{distro}} насб нашудааст",
  ...
  "dialog.provider.agentx.note": "Моделҳои интихобшуда, аз ҷумла Claude, GPT, Gemini ва ғайра",
  "dialog.provider.agentx.tagline": "Моделҳои боэътимоди оптимизатсияшуда",
  "dialog.provider.agentxGo.tagline": "Обунаи арзон барои ҳама",
  ...
  "provider.connect.agentxZen.visit.prefix": "Ташриф",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "барои гирифтани калиди API худ.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode дар {{distro}} тайёр аст.",
  "wsl.onboarding.agentxReady": "OpenCode тайёр аст.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode насб нашудааст",
