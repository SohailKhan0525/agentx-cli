export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode n'est pas installé dans cette distribution",
  "desktop.wsl.error.agentxCannotRun": "opencode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode n'est pas installé dans {{distro}}",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode est prêt dans {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode est prêt.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode non installé",
