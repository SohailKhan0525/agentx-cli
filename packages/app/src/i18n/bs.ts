export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.agentxCannotRun": "opencode je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode nije instaliran u distribuciji {{distro}}",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode je spreman u distribuciji {{distro}}.",
