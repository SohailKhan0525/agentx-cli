export const dict = {
  ...
  "dialog.provider.agentx.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.agentx.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.agentxGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje AgentX",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u AgentX-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u AgentX-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u agentx.json",
  ...
  "dialog.server.description": "Promijeni na koji se AgentX server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija AgentX-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku AgentX timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (agentx.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: AgentX još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AgentX uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni AgentX server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u AgentX-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako AgentX izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li AgentX prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu AgentX-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se AgentX pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju AgentX-a.",
