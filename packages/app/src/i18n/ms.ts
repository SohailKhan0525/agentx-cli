export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode tidak dipasang dalam distro ini",
  "desktop.wsl.error.agentxCannotRun": "opencode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode tidak dipasang dalam {{distro}}",
  ...
  "dialog.provider.agentx.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.agentx.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.agentxGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "provider.connect.agentxZen.visit.prefix": "Layari",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode sedia digunakan.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode belum dipasang",
