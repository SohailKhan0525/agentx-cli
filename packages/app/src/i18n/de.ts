...
export const dict = {
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode ist in {{distro}} bereit.",
  "wsl.onboarding.agentxReady": "OpenCode ist bereit.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode nicht installiert",
  ...
  "desktop.wsl.error.agentxMissing": "opencode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.agentxCannotRun": "opencode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode ist in {{distro}} nicht installiert",
