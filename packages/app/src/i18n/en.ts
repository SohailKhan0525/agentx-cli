export const dict = {
  ...
  "dialog.provider.agentx.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.agentx.tagline": "Reliable optimized models",
  "dialog.provider.agentxGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by AgentX",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in AgentX.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.agentxZen.line1":
    "AgentX Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.agentxZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.agentxZen.visit.prefix": "Visit ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in AgentX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in AgentX.",
  ...
  "dialog.plugins.empty": "Plugins configured in agentx.json",
  ...
  "dialog.server.description": "Switch which AgentX server this app connects to.",
  ...
  "wsl.onboarding.checkingAgentX": "Checking AgentX...",
  "wsl.onboarding.checkingAgentXIn": "Checking AgentX in {{distro}}...",
  "wsl.onboarding.updatingAgentX": "Updating AgentX...",
  "wsl.onboarding.updatingAgentXIn": "Updating AgentX in {{distro}}...",
  "wsl.onboarding.updateAgentXIn": "Update AgentX in {{distro}}.",
  "wsl.onboarding.updateAgentX": "Update AgentX",
  "wsl.onboarding.agentxReadyIn": "AgentX is ready in {{distro}}.",
  "wsl.onboarding.agentxReady": "AgentX is ready.",
  "wsl.onboarding.installAgentXIn": "Install AgentX in {{distro}}.",
  "wsl.onboarding.installAgentX": "Install AgentX",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "AgentX not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before AgentX can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "AgentX could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen AgentX.",
  ...
  "toast.update.description": "A new version of AgentX ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the AgentX team",
  ...
  "error.chain.checkConfig": "Check your config (agentx.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, AgentX does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "AgentX includes free models so you can start immediately.",
  ...
  "app.name.desktop": "AgentX Desktop",
  ...
  "settings.desktop.wsl.description": "Run the AgentX server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for AgentX",
  ...
  "settings.general.row.appearance.description": "Customise how AgentX looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether AgentX follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how AgentX is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when AgentX launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of AgentX.",
