...
export const dict = {
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode is ready.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode not installed",
