export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "このディストリビューションにはopencodeがインストールされていません",
  "desktop.wsl.error.agentxCannotRun": "opencodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}}にはOpenCodeがインストールされていません",
  ...
  "wsl.onboarding.agentxReadyIn": "{{distro}}内のOpenCodeの準備ができました。",
  "wsl.onboarding.agentxReady": "OpenCodeの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCodeがインストールされていません",
