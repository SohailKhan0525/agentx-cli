export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "O opencode não está instalado nesta distribuição",
  "desktop.wsl.error.agentxCannotRun": "O opencode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.agentxNotInstalled": "O OpenCode não está instalado em {{distro}}",
  ...
  "wsl.onboarding.agentxReadyIn": "O OpenCode está pronto em {{distro}}.",
  "wsl.onboarding.agentxReady": "O OpenCode está pronto.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode não instalado",
