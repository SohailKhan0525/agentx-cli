export const dict = {
  ...
  "dialog.provider.agentx.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.agentx.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.agentxGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo AgentX",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no AgentX.",
  ...
  "provider.connect.agentxZen.line1":
    "AgentX Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.agentxZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.agentxZen.visit.prefix": "Visite ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no AgentX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no AgentX.",
  ...
  "dialog.plugins.empty": "Plugins configurados em agentx.json",
  ...
  "dialog.server.description": "Trocar para qual servidor AgentX este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do AgentX ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do AgentX",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (agentx.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: AgentX ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "AgentX inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor AgentX dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do AgentX",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o AgentX aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o AgentX segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o AgentX é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o AgentX iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do AgentX.",
