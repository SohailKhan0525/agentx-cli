export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode no está instalado en esta distribución",
  "desktop.wsl.error.agentxCannotRun": "opencode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode no está instalado en {{distro}}",
  ...
  "dialog.provider.agentx.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode está listo en {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode está listo.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode no está instalado",
