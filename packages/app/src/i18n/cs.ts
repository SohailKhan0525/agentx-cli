export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode není v této distribuci nainstalováno",
  "desktop.wsl.error.agentxCannotRun": "opencode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode není nainstalován v {{distro}}",
  ...
  "dialog.provider.agentx.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.agentx.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.agentxGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.agentxZen.visit.prefix": "Návštěva ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " vyzvedněte svůj klíč API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode je připraveno v {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode je připraven.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode není nainstalováno",
