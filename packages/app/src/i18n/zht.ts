...
export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "此發行版中未安裝 opencode",
  "desktop.wsl.error.agentxCannotRun": "已安裝 opencode，但無法執行",
  "desktop.wsl.error.agentxNotInstalled": "{{distro}} 中未安裝 OpenCode",
  ...
  "dialog.provider.agentx.tagline": "經過最佳化的可靠模型",
  ...
  "provider.connect.agentxZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "wsl.onboarding.agentxReadyIn": "{{distro}} 中的 OpenCode 已就緒。",
  "wsl.onboarding.agentxReady": "OpenCode 已就緒。",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "未安裝 OpenCode",
