export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode ni nameščen v tej distribuciji",
  "desktop.wsl.error.agentxCannotRun": "opencode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode ni nameščen v {{distro}}",
  ...
  "dialog.provider.agentx.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.agentx.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.agentxGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "provider.connect.agentxZen.visit.prefix": "Obisk ",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": " za prevzem ključa API.",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode je pripravljen v {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode je pripravljen.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode ni nameščen",
