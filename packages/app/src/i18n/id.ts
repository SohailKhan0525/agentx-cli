export const dict = {
  ...
  "desktop.wsl.error.agentxMissing": "opencode belum terinstal di distro ini",
  "desktop.wsl.error.agentxCannotRun": "opencode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode belum terinstal di {{distro}}",
  ...
  "dialog.provider.agentx.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.agentx.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.agentxGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "provider.connect.agentxZen.visit.prefix": "Kunjungi ",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode siap di {{distro}}.",
  "wsl.onboarding.agentxReady": "OpenCode siap.",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode belum terinstal",
