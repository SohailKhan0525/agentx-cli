export const dict: Record<string, string> = {
  ...
  "desktop.wsl.error.agentxMissing": "ཌིསི་ཊོ་འདི་ནང་ opencode གཞི་བཙུགས་མ་འབད་བས།",
  "desktop.wsl.error.agentxCannotRun": "opencode འདི་གཞི་བཙུགས་འབད་ཡོད་རུང་ གཡོག་བཀོལ་མ་ཚུགས།",
  "desktop.wsl.error.agentxNotInstalled": "OpenCode འདི་ {{distro}} ནང་གཞི་བཙུགས་མ་འབད་བས།",
  ...
  "dialog.provider.agentx.note": "Claude དང་ GPT དེ་ལས་ Gemini དང་དེ་ལས་ལྷག་སྟེ་ བཀོད་སྒྲིག་འབད་ཡོད་པའི་དཔེ་ཚད།",
  "dialog.provider.agentx.tagline": "བློ་གཏད་ཅན་གྱི་ཡར་རྒྱས་ཅན་གྱི་དཔེ་ཚད་ཚུ།",
  "dialog.provider.agentxGo.tagline": "མི་ཚང་མའི་དོན་ལུ་ གོང་ཚད་དམའ་བའི་ མཁོ་མངགས་འབད་ནི།",
  ...
  "provider.connect.agentxZen.visit.prefix": "འགྱོ་ནི",
  "provider.connect.agentxZen.visit.link": "github.com/SohailKhan0525/agentx-cli/zen",
  "provider.connect.agentxZen.visit.suffix": "ཁྱོད་རའི་ API ལྡེ་མིག་བསྡུ་ལེན་འབད་ནིའི་དོན་ལུ།",
  ...
  "wsl.onboarding.agentxReadyIn": "OpenCode འདི་ {{distro}} ནང་ལུ་གྲ་སྒྲིག་ཡོདཔ་ཨིན།",
  "wsl.onboarding.agentxReady": "OpenCode གྲ་སྒྲིག་ཡོད།",
  ...
  "wsl.onboarding.distroStatus.agentxMissing": "OpenCode གཞི་བཙུགས་མ་འབད་བས།",
