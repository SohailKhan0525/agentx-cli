...
import { SessionStatusEvent } from "@agentx-cli/schema/session-status-event"
import { SessionV1 } from "@agentx-cli/schema/session-v1"
import type {
  AssistantMessage,
  GlobalEvent,
  Message,
...
export const directory = "C:/AgentX/TimelineStability"
...
export const model = { providerID: "agentx", modelID: "claude-opus-4-6", variant: "max" }
