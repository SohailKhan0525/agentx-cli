...
> current private `@agent-qofeno/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@agent-qofeno/ai`
...
import { LLM } from "@agent-qofeno/ai"
import { OpenAI } from "@agent-qofeno/ai/providers/openai"
...
```ts
import { Message } from "@agent-qofeno/ai"
...
import { LLM, Tool } from "@agent-qofeno/ai"
...
```ts
import { LLM } from "@agent-qofeno/ai/promise"
import { OpenAI } from "@agent-qofeno/ai/providers/openai"
...
```ts
import { LLMSchema } from "@agent-qofeno/ai/schema"
...
```ts
import { Provider, Protocol } from "@agent-qofeno/ai/provider"
...
@agent-qofeno/ai/promise
  Promise/AsyncIterable LLM facade

@agent-qofeno/ai/schema
  serializable domain schemas

@agent-qofeno/ai/provider
  experimental Provider and Protocol authoring APIs

@agent-qofeno/ai/providers/openai
@agent-qofeno/ai/providers/anthropic
@agent-qofeno/ai/providers/google
...
```
