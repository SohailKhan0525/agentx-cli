...
- Effect plugins import `@agentx-cli/plugin/v2/effect`, not `@agentx-cli/core`.
- Public domain values use generated `@agentx-cli/sdk` types.
...
- Define `PluginHost` domain capabilities in `@agentx-cli/plugin/v2/effect`.
