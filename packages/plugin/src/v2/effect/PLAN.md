...
- Effect plugins import `@agent-qofeno/plugin/v2/effect`, not `@agent-qofeno/core`.
- Public domain values use generated `@agent-qofeno/sdk` types.
...
- Define `PluginHost` domain capabilities in `@agent-qofeno/plugin/v2/effect`.
