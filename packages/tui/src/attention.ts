...
import defaultSoundPath from "@agent-qofeno/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@agent-qofeno/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@agent-qofeno/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@agent-qofeno/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@agent-qofeno/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@agent-qofeno/ui/audio/yup-01.mp3" with { type: "file" }
