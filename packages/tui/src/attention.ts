...
import defaultSoundPath from "@agentx-cli/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@agentx-cli/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@agentx-cli/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@agentx-cli/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@agentx-cli/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@agentx-cli/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_PACK_ID = "agentx.default"
