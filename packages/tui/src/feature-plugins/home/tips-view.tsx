import type { TuiPluginApi } from "@agent-qofeno/plugin/tui"
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public github.com/SohailKhan0525/agentx-cli link",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.agentx/commands/{/highlight} for reusable prompts",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/SohailKhan0525/agentx-cli{/highlight} in a container",
