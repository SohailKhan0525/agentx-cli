import type { TuiPluginApi } from "@agentx-cli/plugin/tui"
...
export function Tips(props: { api: TuiPluginApi; connected?: boolean }) {
  ...
  const shortcuts: Shortcuts = {
    ...
    statusView: useCommandShortcut("agentx.status"),
...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at github.com/SohailKhan0525/agentx-cli",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.agentx/commands/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.agentx/agents/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.agentx/plugins/{/highlight} for event hooks",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/SohailKhan0525/agentx-cli{/highlight} for containerized use",
