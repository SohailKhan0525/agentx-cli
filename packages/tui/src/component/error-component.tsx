...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/anomalyco/agentx/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("agentx-version", InstallationVersion)
