...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "AGENTX.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/agentx/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/agentx (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/agentx/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/agentx/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const AGENTX_DB|AGENTX_DB|AGENTX_DEV|Global\\.Path\\.data|data =" in packages/agentx/src (115 matches)',
  },
] as const
