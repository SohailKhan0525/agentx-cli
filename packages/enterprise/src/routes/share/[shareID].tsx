import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@agent-qofeno/sdk/v2"
import { SessionTurn } from "@agent-qofeno/session-ui/session-turn"
import { SessionReview } from "@agent-qofeno/session-ui/session-review"
import { DataProvider } from "@agent-qofeno/session-ui/context"
import { FileComponentProvider } from "@agent-qofeno/ui/context/file"
import { WorkerPoolProvider } from "@agent-qofeno/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@agent-qofeno/ui/logo"
import { IconButton } from "@agent-qofeno/ui/icon-button"
import { ProviderIcon } from "@agent-qofeno/ui/provider-icon"
import { iife } from "@agent-qofeno/core/util/iife"
import { Binary } from "@agent-qofeno/core/util/binary"
import { NamedError } from "@agent-qofeno/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@agent-qofeno/ui/tabs"
import { MessageNav } from "@agent-qofeno/session-ui/message-nav"
import { FileSSR } from "@agent-qofeno/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@agent-qofeno/session-ui/pierre/worker").then((m) => ({
