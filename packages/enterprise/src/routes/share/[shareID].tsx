import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@agentx-cli/sdk/v2"
import { SessionTurn } from "@agentx-cli/session-ui/session-turn"
import { SessionReview } from "@agentx-cli/session-ui/session-review"
import { DataProvider } from "@agentx-cli/session-ui/context"
import { FileComponentProvider } from "@agentx-cli/ui/context/file"
import { WorkerPoolProvider } from "@agentx-cli/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@agentx-cli/ui/logo"
import { IconButton } from "@agentx-cli/ui/icon-button"
import { ProviderIcon } from "@agentx-cli/ui/provider-icon"
import { iife } from "@agentx-cli/core/util/iife"
import { Binary } from "@agentx-cli/core/util/binary"
import { NamedError } from "@agentx-cli/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@agentx-cli/ui/tabs"
import { MessageNav } from "@agentx-cli/session-ui/message-nav"
import { FileSSR } from "@agentx-cli/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@agentx-cli/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/agentx-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | AgentX</Title>
              </Show>
              <Meta name="description" content="agentx - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://github.com/SohailKhan0525/agentx-cli/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
