...
export type Config = {
  ...
  /**
   * Command configuration, see https://github.com/SohailKhan0525/agentx-cli/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/SohailKhan0525/agentx-cli/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
