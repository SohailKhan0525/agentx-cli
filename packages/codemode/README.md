...
{
  "dependencies": {
    "@agent-qofeno/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@agent-qofeno/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@agent-qofeno/codemode"
...
```ts
import { toolError } from "@agent-qofeno/codemode"
